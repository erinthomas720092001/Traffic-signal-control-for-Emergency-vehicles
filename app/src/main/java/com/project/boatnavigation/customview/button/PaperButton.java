...
public class PaperButton extends View {
    ...
    private static final float MIN_SHADOW_COLOR_ALPHA = 0.3f;
    ...
    private RectF getRectF() {
        if (backgroundRectF == null) {
            ...
            backgroundRectF.bottom = (float) (getHeight() - ((float)(mPadding)*.40));
        }
            ...
            case MotionEvent.ACTION_UP:
                if (!mMoveOutside) {
                    ...
                    if(onClickListener!=null){
                        onClickListener.onClick(PaperButton.this);
                    }
                }
                break;
