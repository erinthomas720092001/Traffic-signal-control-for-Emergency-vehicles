...
public class FloatingEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    public FloatingEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineColorINt = attributes.getColor(R.styleable.FloatingEditText_floating_edit_text_highlighted_color,
                getResources().getColor(R.color.floating_edit_text_line_color));
        ...
        lineColor.setColor(lineColorINt);

        this.setTextColor(Utils.getColor(context,R.color.app_label_color_secondary));
            ...
            public void draw(Canvas canvas) {
                if (mVerified) {
                    if (isFocused()) {
                        ...
                        canvas.drawRect(rect, lineColor);
                    ...
                    mHintPaint.setColor(mErrorColor);
                    mHintPaint.setTextSize(getTextSize() * 0.75f);
                    Log.d(TAG, "Old Value :- "+(getTextSize() * 0.6f));
                    Log.d(TAG, "New Value :- "+(getTextSize() * 0.75f));
        ...
        if (!TextUtils.isEmpty(getHint())) {
            ...
            switch (mState) {
                case StateHintNormal: {
                    ...
                    hintY = maxHintY;
                    mHintPaint.setColor(mColor);
                    mHintPaint.setTextSize((int)(textSize*(1.1)));
